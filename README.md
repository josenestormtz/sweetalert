...
## [Cambiar el texto del botón OK](https://github.com/josenestormtz/sweetalert/blob/ebd080b4cf65cb02c484dfd6574ff19328120f34/personalizar-botones.md)
En esta guía aprenderás cómo personalizar el texto del botón de confirmación en las alertas de SweetAlert2 usando la propiedad confirmButtonText, además de modificar el texto y color de los botones de confirmación y cancelación para adaptarlos al estilo de tu aplicación.
